    ...
    <div className="prose max-w-3xl mx-auto py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mb-2">
          <strong>TypeScript</strong> is a strongly typed programming language that builds on JavaScript, adding static type definitions. Using TypeScript in Next.js helps catch errors early, improves code quality, and provides better autocompletion and refactoring support in your editor.
        </p>
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc ml-6 space-y-2 text-muted-foreground">
          <li><strong>Create a Next.js project:</strong> <code>npx create-next-app@latest your-app-name</code> scaffolds a new Next.js app.</li>
          <li><strong>Add TypeScript and types:</strong> <code>npm install --save-dev typescript @types/react @types/node</code> installs the TypeScript compiler and type definitions for React and Node.js.</li>
          <li><strong>Auto-generate <code>tsconfig.json</code>:</strong> The first time you run <code>npm run dev</code>, Next.js will detect TypeScript and create a <code>tsconfig.json</code> with sensible defaults.</li>
          <li><strong>Recommended <code>tsconfig.json</code> options:</strong> Next.js sets up required options, but you can customize as needed. Keep <code>&quot;jsx&quot;: &quot;preserve&quot;</code> for compatibility.</li>
          <li><strong>Write <code>.ts</code> and <code>.tsx</code> files:</strong> Use <code>.tsx</code> for React components, <code>.ts</code> for logic/helpers. Rename files as needed.</li>
        </ul>
      </div>
      <ol>
        <li>
