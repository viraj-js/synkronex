    ...
    <Card className="mb-8">
      <CardContent className="py-8">
        ...
        <p className="mb-6 text-muted-foreground">
          <strong>react-syntax-highlighter</strong> is a popular React library for rendering code blocks with syntax highlighting, supporting dozens of programming languages and themes. It's perfect for documentation, blogs, or any app where you want to display code beautifully and readably.
        </p>
        ...
        <h2 className="text-xl font-semibold mb-2">TypeScript Support: Why a Custom <code>.d.ts</code> File?</h2>
...
declare module 'react-syntax-highlighter/dist/esm/styles/prism';`}
        ...
        <h2 className="text-xl font-semibold mb-2">Example: Using <code>react-syntax-highlighter</code> in a Next.js Component</h2>
        <p className="mb-4 text-muted-foreground">
        ...
        />
        <p className="mb-6 text-muted-foreground">
          <strong>What this does:</strong> Imports the Prism-based syntax highlighter and the One Dark theme, then renders a code block with syntax highlighting for TypeScript/TSX code. Thanks to your <code>.d.ts</code> file, TypeScript will not complain about missing types for these imports.
        </p>
