      ...
      <Card className="mb-8">
        <CardContent className="py-8">
          ...
          <h1 className="text-3xl font-bold mb-2 flex items-center gap-2">
            🚀 Add PWA Support to Next.js
          </h1>
          <p className="mb-4 text-muted-foreground">
            Learn how to enable Progressive Web App (PWA) features in your Next.js project using{' '}
            <code>next-pwa</code> and a manifest file.
          </p>
          <h2 className="text-xl font-semibold mb-2">1. Install next-pwa</h2>
          <CodeBlock code="npm install next-pwa" language="bash" />
          <h2 className="text-xl font-semibold mt-6 mb-2">
            2. Configure next-pwa in <code>next.config.ts</code>
          </h2>
          <CodeBlock
          ...
          <p className="mb-2">
            Create <code>public/manifest.json</code> with your app details:
          </p>
          <CodeBlock
          ...
          />
          <h2 className="text-xl font-semibold mt-6 mb-2">
            4. Reference Manifest in <code>layout.tsx</code>
          </h2>
          <CodeBlock
          ...
          <p className="mt-4 text-muted-foreground text-sm">
            PWA features (service worker, offline, install prompt) are only enabled in production
            builds.
          </p>
        </CardContent>
      </Card>
