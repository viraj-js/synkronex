...
const SignUpForm: React.FC = () => {
    ...
    const { trigger, formState: { isSubmitting } } = formMethods;
            ...
            <div className="w-full max-w-lg mx-4 relative z-10">
                ...
                <div className="text-center mb-6 animate-fade-in">
                    ...
                    <p className="text-slate-300 text-sm md:text-base mt-3 leading-relaxed">
                        Complete the steps below to join our community and get started.
                    </p>
                </div>
                ...
                <FormProvider {...formMethods}>
                    ...
                    >
                        ...
                        <div className="relative">
                            <FormErrorBoundary>
                                <div className="mb-6">
                                    <h2 className="text-xl font-semibold mb-4 text-center bg-gradient-to-r from-blue-100 to-white bg-clip-text text-transparent">
                                        {currentStep.label}
                                    </h2>
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-slate-300 text-sm">
                                    ...
                                    <a
                                        href="/login"
                                        className="text-blue-400 hover:text-blue-300 transition-colors duration-200 font-medium underline decoration-blue-400/30 hover:decoration-blue-300/50 underline-offset-2"
                                    >
                                        Sign In
                                    </a>
                                </p>
